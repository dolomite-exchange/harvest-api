...
module.exports = {
  ...
  aiFARM: {
    ...
    decimals: '18',
    tokenAddress: addresses.ARBITRUM_ONE.aiFARM,
    displayName: 'aiFARM',
    vaultAddress: null,
    priceFunction: { type: GET_PRICE_TYPES.F_TOKEN, params: [addresses.iFARM, '18'] },
  },
  crv_tri_crypto: {
    ...
    vaultAddress: addresses.ARBITRUM_ONE.crv_tri_crypto.NewVault,
    priceFunction: {
      type: GET_PRICE_TYPES.CURVE_POOL,
      params: [
        addresses.V2.crvThreeCrypto.Miner,
  ...
  aWBTC: {
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: './icons/wbtc.png',
    tokenAddress: addresses.ARBITRUM_ONE.aWBTC,
    decimals: '8',
    vaultAddress: null,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_CONTRACT, params: [addresses.WBTC] },
  },
  aETH: {
    chain: CHAINS_ID.ARBITRUM_ONE,
    logoUrl: './icons/eth.png',
    tokenAddress: addresses.ARBITRUM_ONE.aETH,
    decimals: '8',
    vaultAddress: null,
    priceFunction: { type: GET_PRICE_TYPES.COINGECKO_CONTRACT, params: [addresses.WETH] },
  },
