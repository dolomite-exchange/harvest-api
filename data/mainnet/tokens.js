...
module.exports = {
  ...
  Sushi_ETHDAI_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthDaiSushi_Strategy.Underlying, 'WETH_arbitrum', 'DAI_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_DAI, 'WETH_arbitrum', 'DAI_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
    cmcRewardTokenSymbols: ['FARM', 'ETH', 'DAI'],
  },
  Sushi_ETHGOHM_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthGOhmSushi_Strategy.Underlying, 'WETH_arbitrum', 'GOHM_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_GOHM, 'WETH_arbitrum', 'GOHM_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
  ...
  Sushi_ETHMAGIC_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthMagicSushi_Strategy.Underlying, 'WETH_arbitrum', 'MAGIC_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_MAGIC, 'WETH_arbitrum', 'MAGIC_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
  ...
  Sushi_ETHMIM_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthMimSushi_Strategy.Underlying, 'WETH_arbitrum', 'MIM_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_MIM, 'WETH_arbitrum', 'MIM_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
  ...
  Sushi_ETHSPELL_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthSpellSushi_Strategy.Underlying, 'WETH_arbitrum', 'SPELL_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_SPELL, 'WETH_arbitrum', 'SPELL_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
  ...
  Sushi_ETHSUSHI_arbitrum: {
    ...
    priceFunction: {
      type: GET_PRICE_TYPES.LP_TOKEN,
      params: [addresses.ARBITRUM_ONE.EthSushiSushi_Strategy.Underlying, 'WETH_arbitrum', 'SUSHI_arbitrum'],
    },
    estimateApyFunctions: [
      {
        type: ESTIMATED_APY_TYPES.SUSHI,
        params: [ARBITRUM_SUSHI_POOLS_IDS.ETH_SUSHI, 'WETH_arbitrum', 'SUSHI_arbitrum', '0.75', CHAINS_ID.ARBITRUM_ONE],
      },
    ],
    cmcRewardTokenSymbols: ['FARM', 'ETH', 'SUSHI'],
  },
